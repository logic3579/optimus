...
func TestPipelineHandlerMountsExactRoutesAndPermissions(t *testing.T) {
	...
	want := map[string]bool{"GET /api/v1/delivery/projects/:id/pipeline": true, "PUT /api/v1/delivery/projects/:id/pipeline": true, "GET /api/v1/delivery/projects/:id/artifacts": true}
